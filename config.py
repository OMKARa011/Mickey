...
API_ID = int(getenv("API_ID", "23310068"))
API_HASH = getenv("API_HASH", "64244e8df82d0cb1cd2938b22e2d33b6")
BOT_TOKEN = getenv("BOT_TOKEN", "7132003441:AAF4EQ45ELwp8Ne068nw3_MXn8AR753W9-w")
